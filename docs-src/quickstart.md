...
OpenShift Console **Helm** form: set **Cluster Router Base** (required), OpenShift token, and LiteMaaS key. Leave Git revision empty to pin `v` + chart version (e.g. `v0.1.9`).
